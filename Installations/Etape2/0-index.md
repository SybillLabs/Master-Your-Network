...
- `ns-router` : routeur principal avec pfSense.
...
1. 🛜 [Mise en place du routeur pfSense](/Installations/Etape2/1-routeur.md) : Configuration initial du WAN/LAN/DMZ et des règles de pare-feu de base.
2. 🖧 [Mise en place des VLANs](/Installations/Etape2/2-VLANs.md) : Configuration de trois VLANs dans le LAN via et géré par le routeur pfSense.
